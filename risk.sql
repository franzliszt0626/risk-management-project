...
create schema `risk-management-project` collate utf8mb3_bin;
...
(
    ...
    alert_level enum ('警告', '严重') default '警告'            not null comment '预警级别',
...
(
    ...
    respiratory_rate int                                             default 0                 null comment '呼吸率(次/分钟)',
...
(
    ...
    area_risk_level enum ('低风险', '中风险', '高风险') default '低风险'          null comment '区域风险等级',
...
(
    ...
    work_type   enum ('高空作业', '受限空间', '设备操作', '正常作业') default '正常作业'        not null comment '工作类型',
