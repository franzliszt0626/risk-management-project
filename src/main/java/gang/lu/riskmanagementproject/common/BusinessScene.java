...
public class BusinessScene {
    ...
    public static final String HANDLE_ALERT_RECORD = "标记预警记录已处理";
    ...
    public static final String GET_HISTORY_RISK_INDICATOR_BY_WORKER_ID = "根据工人id查询历史风险指标";


    public static final String ADD_WORK_AREA = "新增工作区域";
    public static final String GET_WORK_AREA = "查询工作区域";
    ...
    public static final String GET_WORKER = "查询工人";
