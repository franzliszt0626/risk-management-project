...
public class WorkAreaController {
    ...
    public Result<Boolean> deleteWorkArea(@PathVariable Long id) {
    ...
    public Result<Boolean> updateWorkArea(@PathVariable Long id, @RequestBody WorkAreaDTO dto) {
    ...
    @ApiImplicitParam(name = "id", value = "工作区域ID", required = true, dataType = "Long", paramType = "path", example = "1")
    public Result<WorkAreaVO> getWorkAreaById(@PathVariable Long id) {
    ...
    public Result<List<WorkAreaVO>> getWorkAreaByCode(@PathVariable String areaCode) {
