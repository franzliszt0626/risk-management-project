...
public interface FailedMessages {
    ...
    // ======================== 算法服务异常信息 ==========================
    @SuppressWarnings("AlibabaCommentsMustBeJavadocFormat")
    String ALGORITHM_ERROR = "【算法服务异常】算法服务异常！";
    String ALGORITHM_UNREACHABLE = "【算法服务异常】算法服务不可达，请检查算法服务是否启动！";
    ...
    // ========================= 风险预测相关失败信息 =====================
    @SuppressWarnings("AlibabaCommentsMustBeJavadocFormat")
    String RISK_INDICATOR_EMPTY = "【参数校验错误】该工人暂无历史风险记录，无法进行预测！";
    String AI_MODEL_INVALID = "【模型调用错误】AI服务暂不可用！";
    String AI_MODEL_CONNECTION_FAIL = "【模型调用错误】AI服务连接失败！";
    String AI_RESPONSE_RESOLVE_FAILURE = "【解析响应失败】AI响应解析失败，请重试！";
    String LIMIT_INVALID = "【参数校验错误】可接受历史记录范围为1-100个！";
    String PDF_LIMIT_INVALID = "【参数校验错误】pdf可接受历史记录范围为1-200个！";
    String PDF_GENERATE_FAILED = "【PDF生成失败】PDF生成失败，请稍后重试！";
}