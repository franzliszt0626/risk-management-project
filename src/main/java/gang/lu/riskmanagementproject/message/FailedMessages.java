 ...
 * 系统操作失败提示信息常量
 * <p>
 * 统一管理各模块操作失败的提示文案，格式为：【错误类型】错误描述。
...
public interface FailedMessages {
    ...
    String COMMON_INVALID_ID_ERROR_WITHOUT_PREFIX  = "【参数校验失败】无效的%s，请确认ID是否正确！";
    ...
    String COMMON_BIZ_EXCEPTION_SERVER             = "【业务异常-服务端】";
    String COMMON_BIZ_EXCEPTION_CLIENT             = "【业务异常-客户端】";
    String COMMON_PARAM_ILLEGAL_ERROR              = "【参数校验失败】参数不合法：%s！";
    String COMMON_PARAM_TYPE_MISMATCH_ERROR        = "【参数校验失败】参数【%s】格式错误，请传入有效的 %s 类型值（当前值：%s）！";
    String COMMON_DUPLICATE_KEY_ERROR              = "【数据库操作失败】数据重复，请检查后重试！";
    String COMMON_EMPTY_RESULT_ERROR               = "【数据库操作失败】未查询到相关数据！";
    ...
    String ALGORITHM_ERROR       = "【算法服务异常】算法服务内部异常！";
    String ALGORITHM_UNREACHABLE = "【算法服务异常】算法服务不可达，请检查算法服务是否已启动！";
    String VIDEO_EMPTY           = "【上传视频异常】视频文件不能为空！";
    String VIDEO_SIZE_INVALID    = "【上传视频异常】视频文件大小不能超过50MB，当前：%sMB！";
    String VIDEO_TYPE_INVALID    = "【上传视频异常】不支持的视频格式，请上传 mp4/avi/mov 格式的视频！";

    // ==============================8. AI 风险预测失败信息================================

    String RISK_INDICATOR_EMPTY        = "【参数校验失败】该工人暂无历史风险记录，无法进行预测！";
    String LIMIT_INVALID               = "【参数校验失败】可接受历史记录范围为1-100条！";
