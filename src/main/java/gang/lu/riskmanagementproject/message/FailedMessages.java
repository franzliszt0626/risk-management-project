...
public interface FailedMessages {
    ...
    /**
     * 通用失败信息
     * <p>适用于系统级、参数校验、JSON解析、运行时等跨模块的通用错误场景。
     */
    ...
    /**
     * 风险指标业务失败信息
     * <p>覆盖心率、呼吸率、疲劳百分比的范围校验，以及记录存在性、批量操作等场景。
     */
    ...
    /**
     * 预警记录业务失败信息
     * <p>覆盖预警等级、类型、处理人的非空/格式校验，以及已处理幂等、批量操作等场景。
     */
    ...
    /**
     * 算法服务异常信息
     * <p>覆盖 Python 算法服务不可达、视频文件格式/大小非法等场景。
     */
    ...
    /**
     * AI 风险预测失败信息
     * <p>覆盖 Qwen 模型调用、响应解析、参数范围校验及 PDF 生成等场景。
     */
